...
/*zx：上传头像工具类*/
public class UploadHeadPicUtil {

    private static UploadHeadPicUtil uploadUtil;
     ...
     * @return
     */
    public static UploadHeadPicUtil getInstance() {
        if (null == uploadUtil) {
            uploadUtil = new UploadHeadPicUtil();
        }
        return uploadUtil;
    }
