        ...
        Thread thread = new Thread(){
            ...
            public void run() {
                ...
                try {
                    ...
                    DefaultAttribute.DEFAULT_userHEADURL = jsonObject.getString("image");

                    URL url1 = new URL(s + "getHead?path=" + DefaultAttribute.DEFAULT_userHEADURL);
                    InputStream in = url1.openStream();
                    Bitmap userhead = BitmapFactory.decodeStream(in);
                    DefaultAttribute.DEFAULT_userHEAD = userhead;
